...
![image-20211122200231515](实现 DES 的工作模式.assets/image-20211122200231515.png)



![image-20211206210606456](实现 DES 的工作模式.assets/image-20211206210606456.png)

密码分组链接模式（CBC)的加密过程：

$$C_1=E(K,[P_1\bigoplus IV]),\\ C_j =E(K,[P_1\bigoplus C_ {j-1}]),j=2,3,···N  $$

![image-20211122201417784](实现 DES 的工作模式.assets/image-20211122201417784.png)



![image-20211206210643415](实现 DES 的工作模式.assets/image-20211206210643415.png)

![image-20211206210740354](实现 DES 的工作模式.assets/image-20211206210740354.png)
...
![img](实现 DES 的工作模式.assets/250px-DES-main-network.gif)
...
![QQ图片20211206205557](实现 DES 的工作模式.assets/QQ图片20211206205557.png)
...
![img](实现 DES 的工作模式.assets/250px-Data_Encription_Standard_Flow_Diagram.svg-16387906710766.png)
...
![image-20211209181748702](实现 DES 的工作模式.assets/image-20211209181748702.png)

##### 解密

![image-20211209181831804](实现 DES 的工作模式.assets/image-20211209181831804.png)

#### CBC模式

##### 加密

![image-20211209181908357](实现 DES 的工作模式.assets/image-20211209181908357.png)

##### 解密

![image-20211209181922941](实现 DES 的工作模式.assets/image-20211209181922941.png)

#### 控制台自行输入内容

![image-20211212181219419](实现 DES 的工作模式.assets/image-20211212181219419.png)

#### 文件输入输出

![image-20211212180926817](实现 DES 的工作模式.assets/image-20211212180926817.png)

### 2． 改变 1 位明文观察输出 DES 算法的 16 轮输出，几轮后密文变化达到 32位以上；

想要通过肉眼比较出不同的位数是困难的，可以使用python写一写这种简单的工具

- ![image-20211209191013631](实现 DES 的工作模式.assets/image-20211209191013631.png)

即使是给字符串格式化也可以使用技巧，通过替换换行符实现

- ![image-20211209191656690](实现 DES 的工作模式.assets/image-20211209191656690.png)
...
- ![image-20211209193716836](实现 DES 的工作模式.assets/image-20211209193716836.png)

### 3． 改变 1 位密钥观察输出 DES 算法的 16 轮输出，几轮后密文变化达到 32位以上；

依靠人眼依然不现实

- ![image-20211209194832599](实现 DES 的工作模式.assets/image-20211209194832599.png)

  通过脚本比较，发现在第5轮差异就达到了32以上

- ![image-20211209194913051](实现 DES 的工作模式.assets/image-20211209194913051.png)
...
![image-20211209200436431](实现 DES 的工作模式.assets/image-20211209200436431.png)
...
![image-20211209202522820](实现 DES 的工作模式.assets/image-20211209202522820.png)
